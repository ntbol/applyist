    ...
    <?php include('php/nav.php'); ?>
            ...
            <div class="d-none d-md-block">
                ...
                <div class="d-block d-md-none">
                    <div id="parent">
                        <div class="floats box <?=$trimmedStatus?>">
                            <div class="statusColor">
                                <div class="status-tag-mobile"><span class="invisible"><?=$list['status']?></span></div>
                            </div>
                            <div class="row" style="padding: 15px" >
                                <div class="col-sm-12">
                                    <h2 class="job-title"><?=$list['title']?></h2>
                                    <h5 class="small-header"><span class="far fa-building"></span> <span style="font-weight: 600"><?=$list['company']?></span>&nbsp;&nbsp;&nbsp;<span class="fas fa-map-marker-alt"></span> <?=$list['location']?>&nbsp;&nbsp;&nbsp;<br><span title="Date Applied On"><span class="far fa-calendar-alt"></span> Applied on : <?=$list['date_applied']?></span></h5>
                                    <h5 class="small-header" style="font-style: italic;">
                                        <span class="far fa-clock"></span> Status: <span style="font-weight: 600; font-style: normal;"><?=ucwords($list['status'])?></span> &nbsp;<br><span class="far fa-eye"></span>
                                        <?php
                                        if($list['link'] == null){
                                            echo "<a href='modify.php?listid=" . $list['id'] . "' class='theme-link'>Please Link Original Job</a>";
                                        } else {
        ...
        <script>
            $(function() {
                ...
                $('.statusColor>.status-tag,.status-tag-mobile').each(function(){
